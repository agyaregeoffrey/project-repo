...
package com.activeminds.projectrepo.fcm;
...
import com.activeminds.projectrepo.main.MainActivity;
...
public class MyFirebaseMessagingService extends SendBirdPushHandler {
    ...
    public static void sendNotification(Context context, String messageBody, String channelUrl) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.project_logo))
